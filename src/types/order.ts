...
export interface Bundle { id:string; apiId?:string; name:string; serviceIds:Record<ServiceType,string>; serviceApis?:Record<ServiceType,string>; rotations?:Partial<BundleServiceSelections>; enforceServiceMinimums?:boolean; }
